...
const LEARN_CARDS = [
  {
    ...
    body: `
      <p>The yearly report where a company accounts for itself beyond
      profit. A dozen kinds of disclosure share one PDF:</p>
      <svg class="proj-demo" id="gir-demo" width="480" height="190"
           viewBox="0 0 480 190"></svg>
      <p>We split competitors\u2019 reports into short passages and plot each
      one as a point. <b>Near means similar</b> \u2014 no matter who wrote it.</p>`,
  },
  {
    title: '<span class="new-pill">NEW</span> t-SNE &amp; UMAP',
    body: `
      <p>This plot is a shadow of a 384-dimensional space. A and B keep a
      fixed true distance \u2014 their shadows don\u2019t:</p>
      <svg class="proj-demo" id="proj-demo" width="480" height="250"
           viewBox="0 0 480 250"></svg>
      <p>PCA commits to one angle. <b>t-SNE</b> and <b>UMAP</b> pull true
      neighbors together instead \u2014 both are now in the Projection panel,
      with the full settings grid
      <a href="tsne_umap_viewer.html">here</a>.</p>`,
  },
  {
    title: 'Clicks don\u2019t lie',
    body: `
      <p>Click a passage and its nearest neighbors are ranked in the full
      384-dimensional space \u2014 not on screen.</p>
      <p>So if a spotlit neighbor sits far away, the picture dropped that
      distance. The ranking didn\u2019t.</p>`,
  },
  {
    title: 'The faithfulness badge',
    body: `
      <p>The corner badge scores the current picture: how much variance
      it shows, and <b>Shepard r</b> \u2014 how well on-screen distances
      track true ones. Each dot is a pair of passages:</p>
      <svg class="proj-demo" id="shepard-demo" width="480" height="210"
           viewBox="0 0 480 210"></svg>
      <p>Tight to the diagonal = honest picture. Filter, hit
      <i>Re-project</i>, and watch r rise.</p>`,
  },
];
